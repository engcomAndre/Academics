...
def geraPessoa():
    ...
    matricula = random.randint(0000000000,9999999999)
    fator = 1
    ...
    while True:
        ...
        if operador == "0":
            ...
            for i in range (0,int(quan)):
                lista.append(geraPessoa())
            print("Função Executada com sucesso")

        elif operador == "1":
            print("Cadastrando")
            nome = input("Digite o Nome da Pessoa:\nNome = ")
            matricula = input("Digite o Matricula da Pessoa:\nMatricula = ")
            ...
            for i in lista:
                print('%-012s %-30s %4s    %4s    %4s'%(i.matricula,i.nome,i.p1,i.p2,i.n1))
