    ...
    <div class="row">
        ...
        <div class="col-sm c2">
            ...
            <div class="row c2-l1 rounded border border-secondary">
                <h2 class="txtquestao">Cadastro de Atendentes:<h2>
            </div><br>

            <form action="cadastro_atendente1.php" method="post" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="endereço" name="endereço" placeholder="Digite aqui o endereço do atendente" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="posto" name="posto" class="form-control">
