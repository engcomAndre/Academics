    ...
    <div class="row">
        ...
        <div class="col-sm c2">
            ...
            <div class="row c2-l1 rounded border border-secondary">
                <h2 class="txtquestao">Chamada de Fichas<h2>
            </div><br>

            <form action="verificarfichas1.php" method="post" >

                <div class="form-group">
                    <label for="imprimeFicha">Chamada de Fichas:(Escolha um Data)</label>
                    <select id="vardata" name="vardata" class="form-control">
                        <?php
                        ...
                        if($row = mysql_fetch_assoc($res)){
                            ...
                            echo "<option>Sem Dias Para Verificar</option>";
                        }
                ...
                <br>
                <button type="submit" class="btn btn-primary">Verificar Fichas</button>
